...
\item Finally we need to connect the Arduino and the website. We can do this by using a RaspberryPi on our local network to host the website! We used Python3 Flask 

% Column break
\vfill\eject

\item First we initialize the serial port on the RaspberryPi.
